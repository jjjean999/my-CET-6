  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
      ...
      <div class="grid grid-cols-3 gap-4 mb-8">
        <div
          class="bg-white/90 dark:bg-gray-800/90 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 text-center"
        >
        ...
        >
          ...
          <div class="text-2xl font-bold text-primary-500">{{ wpm }}</div>
        </div>
        <div
          class="bg-white/90 dark:bg-gray-800/90 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 text-center"
        >
