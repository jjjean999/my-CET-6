...
const category = ref((savedChapter && chapters.includes(savedChapter)) ? savedChapter : chapters[0])
    ...
    <div class="border border-gray-200 rounded-lg bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
      ...
      <div class="items-center justify-between lg:flex">
        <div class="mb-4 lg:mb-0">
          ...
          <span class="text-base font-normal text-gray-500 dark:text-gray-400">涵盖 CET-6 高频核心词，共 50 个 List、每 List 30 词，逻辑词群记忆法，结合遗忘曲线复习效果更佳</span>
          <p class="mt-2 text-xs text-gray-400 dark:text-gray-500 leading-relaxed">
            📌 备考顺序建议：若距离考试超过 30 天，建议先集中进行词汇训练，待词汇基础扎实后再开始阅读和听力练习。词汇量不足时直接刷阅读听力，容易因生词过多而事倍功半。若已临近考试（≤30 天），则需词汇、阅读、听力同步推进。
          </p>
        </div>
